...
async function loader() {
  const data = {
    data: {
      ...
      footer: {
        id: 6,
        description: "Next.js landing page powered by Strapi 5 beta.",
        logoLink: {
          id: 13,
          href: "/",
          text: "Strapifive",
        ...
        colOneLinks: [
          { id: 52, href: "/about", text: "About", external: false },
          { id: 53, href: "/blog", text: "Blog", external: false },
        ],
        colTwoLinks: [],
        socialLinks: {
          id: 4,
          ...
          socialLink: [
            {
              id: 54,
              href: "https://www.youtube.com/@codingafterthirty",
              text: "YouTube",
              external: true,
            },
            {
              id: 55,
              href: "https://github.com/PaulBratslavsky/nextjs-strapify-frontend",
              text: "GitHub",
              external: true,
            },
            {
              id: 56,
              href: "https://x.com/codingthirty",
              text: "Twitter",
              external: true,
            },
          ],
